...
TARGET_BOT_USERNAMES = os.getenv(
    ...
    '@Dairy_share2bot,@Throne122809bot,@quality_filesbot,@File_extractorbot,@Flipkart_filebot,@Kitkat_sharebot,@Unfiltered_filebot,@Desiiihub_bot,@Sanzzyyyyyfree_bot,@Instaidsbot,@Arararararararobot,@UwUlinkbot,@Oneetouch_bot,@File_senderrbot,@Niggerndra_bot,@Happystreettsbot,@Juicerequestbot,@Earningtipssbot,@Monkepostingbot,@Premiumposterrbot,@MarleGbot,@Lmaoxdfilebot,@arigatooooooobot,@Onisannnnnbot,@Amazon_sharebot,@Auto_accept_request12_bot,@alexatg_bot,@madagascbot,@suzubaebot,@topgoftgsbot,@thetunderbot,@horrorpono0bot,@assisantgcbot,@socialworkerbot'
).split(',')
