...
# Post Channel ID where modified posts will be reposted
post_channel_id = os.getenv('POST_CHANNEL_ID', "-1002818242381")  # Default to same as target, change as needed
